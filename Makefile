...
prog: clean main.o util.o jogador.o tabuleiro.o jogo.o tela.o regra1.o regra2.o regra3.o arquivo.o ia.o traducao.o rsa.o
	$(CC) -o Gomoku src/*.o
clean:
	rm -f src/*.o
main.o: 
...
rsa.o:
	$(CC) -o src/RSA.o -c src/RSA.c $(CFLAGS)